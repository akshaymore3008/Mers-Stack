...
function App() {
  ...
  <nav className="navbar navbar-expand-lg navbar-dark fixed-top">
    <div className="container">
      <a className="navbar-brand" href="#">Akshay More</a>
      ...
      <div className="collapse navbar-collapse" id="navbarNav">
        <ul className="navbar-nav ms-auto">
          ...
          <li className="nav-item">
            <a className="nav-link" href="./aboutus.html" target="_blank">About</a>
          </li>
          <li className="nav-item">
  ...
  <h1 className="hari">Akshay More</h1>
  <!-- Skills Section -->
        ...
        <div className="col-md-6 mb-4">
          <form className="contact-form">
            <div className="mb-3">
              ...
              <input type="text" className="form-control" id="name" placeholder="Akshay More" />
            </div>
            <div className="mb-3">
              <label for="email" className="form-label">Email</label>
              <input type="email" className="form-control" id="email" placeholder="morea1997@gmail.com" />
            </div>
            <div className="mb-3">
  ...
  <footer>
    <div className="container">
      <p>© 2025 Akshay More. All Rights Reserved.</p>
      <p>
  ...
  <div className="box-1">
    <p className="text-white">Akshay</p>
  </div>
  <div className="box-2">
    <p className="text-white text-h">Akshay</p>
  </div>
